...
OUTPUT_PATH="${OUTPUT_PATH:-$ALPHABOOK_ROOT/logs/cloudflare-corpus-audit.json}"
...
cd "$INGEST_REPO_ROOT"
npx tsx apps/ingest/src/index.ts audit-cloudflare-corpus "$START_AFTER_ID" "$LIMIT" "$OUTPUT_PATH"
