...
function buildSearchPrompt(runtimePrompt, manifest, task, evidence, question) {
  ...
  return [
    ...
    "- First use the Postgres-backed corpus CLI at node /workspace/context/search-db.mjs for corpus-wide regex and keyword search before downloading local files.",
    "- node /workspace/context/search-db.mjs rg behaves like ripgrep over the chunks table and can be piped into sed, awk, jq, and other shell tools.",
    "- Example commands:",
